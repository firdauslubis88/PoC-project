...
struct CustomPeerConnectionClientObserver {
	virtual void OnSignedIn() = 0;  // Called when we're logged on.
	virtual void OnSignedOut() = 0;  // Called when we're logged on.
...
protected:
	virtual ~CustomPeerConnectionClientObserver() {}
};

class CustomPeerConnectionClient : 
...
public:
	...
	void RegisterObserver(CustomPeerConnectionClientObserver* callback);
...
protected:
	...
	CustomPeerConnectionClientObserver* callback_;
