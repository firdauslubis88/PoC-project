...
class ATANCamera {
 public:
  ...
  // Jul. 2010, Min-Hyuk Sung
  inline Vector<2> GetFocalLength() {return mvFocal;};
  inline Vector<2> GetImageCenter() {return mvCenter;};
  void RefreshParams();
 ...
 protected:
  Vector<NUMTRACKERCAMPARAMETERS> mCameraParams;
